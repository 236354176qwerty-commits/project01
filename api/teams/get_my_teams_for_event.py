...
@teams_bp.route('/events/<int:event_id>/my-teams', methods=['GET'])
def api_get_my_teams_for_event(event_id):
    ...
    try:
        ...
        with db_manager.get_connection() as conn:
            ...
            cursor.execute(
                ...
                """,
                (event_id, current_user_id, current_user_id, current_user_id),
            )
        ...
        return jsonify({'success': False, 'message': f'获取队伍信息失败: {str(e)}'}), 500
